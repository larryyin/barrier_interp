...
URL = 'http://hudson.dl.stevens-tech.edu/njdemo/battery/'
...
file_inun_cna = dir_tmp+'_cna.tif'
#file_inun_cna2 = dir_temp+'_cna2.tif'
file_tile_i1 = dir_tmp+'_tile1.vrt'
file_tile_i2 = dir_tmp+'_tile2.vrt'
...
#call(['PYTHONPATH=/mnt/cstor01/home/lyin1/njdemo', 'gdal2tiles_larry.py', '-p', 'mercator', '-z', '8-20', \
#      '-n', '-w', 'google', \
